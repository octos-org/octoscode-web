...
This directory explains the product as a browser client, how to work on it,
and why its durable boundaries exist. Start with the shortest document that
...
- Machine-readable compatibility truth belongs in
  `packages/client/contract-source.json` and `packages/client/core-runtime.json`,
  not in prose version claims.
